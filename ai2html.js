...
function main() {
  ...
  var defaultSettings = {
    ...
    "image_format": "svg",  // Options: auto, png, png24, jpg, svg
    ...
    "tnl_project_name": "", // the news lens project name
    "project_type": "",
  ...
  function generateImageHtml(imgFile, imgId, imgClass, imgStyle, ab, settings) {
    ...
    html += ' src="' + 'https://datastore.thenewslens.com/infographic/tnl-ai2html/figures/' + settings.tnl_project_name + '/' +  src + '"/>\r'; // add tnl image path on GCS
    return html;
  }
